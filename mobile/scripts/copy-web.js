...
function copyMobileAssets() {
  const assets = ['ble-adapter.js', 'capacitor-bootstrap.js', 'drive-auth-native.js', 'foreground-service.js'];
...
function watch() {
  ...
  const mobileAssets = ['ble-adapter.js', 'capacitor-bootstrap.js', 'drive-auth-native.js', 'foreground-service.js'].map(f => path.join(mobileRoot, 'src', f));
